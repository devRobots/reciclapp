...
class Defaults(private val context: Activity, private val roomApp: RoomApp) {
    ...
    private suspend fun initVenta() {
        ...
        roomApp.local.ventaDAO().insertar(listOf(venta1, venta2))
    }
    ...
    private suspend fun initCita() {
        ...
        roomApp.local.citaDAO().insertar(listOf(cita1, cita2, cita3, cita4, cita5))
    }
    ...
    private suspend fun initUsuario() {
        ...
        roomApp.local.usuarioDAO().insertar(listOf(usuario1))
    }
    ...
    private suspend fun initAdministrador() {
        ...
        roomApp.local.administradorDAO().insertar(listOf(administrador1))
    }
    ...
    private suspend fun initRecolectores() {
        ...
        roomApp.local.recolectorDAO().insertar(listOf(recolector1, recolector2, recolector3))
    }
    ...
    private suspend fun initCompradores() {
        ...
        roomApp.local.compradorDAO().insertar(listOf(comprador1, comprador2))
    }
